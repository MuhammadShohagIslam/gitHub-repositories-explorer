        ...
        <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow h-[262px]">
            <div className="flex flex-col items-center p-7">
                ...
                <div className="flex mt-4 space-x-3 md:mt-6">
                    <Link to={data.owner_url} className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-400 rounded-lg hover:bg-blue-500 focus:ring-4 focus:outline-none focus:ring-blue-300 ">Profile Details</Link>
                </div>
            </div>
        </div>
    );
